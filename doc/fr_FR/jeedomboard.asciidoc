...
Vous devez télécharger le logicel win32diskimager link:http://sourceforge.net/projects/win32diskimager/[ici, window="_blank"] puis l'installer sur votre pc

=== Etape 2 : Récupération de l'image de Jeedom

Vous devez aller link:https://drive.google.com/open?id=0B9gdDNCtvjAIMmFYTEtISHRxU2s[ici], window="_blank", puis dans le dossier Images récuperer l'image jeedom-#jeeboard#-X.xxx.rar

image:../images/install_humming_1.PNG[]

=== Etape 3 : Décompression de l'image de Jeedom

Décompression de l'image de Jeedom (si vous n'avez rien pour le décompresser vous pouvez installer link:http://www.clubic.com/telecharger-fiche9632-winrar.html[winrar, window="_blank"]), vous devez obtenir : 

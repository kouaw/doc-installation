...
wget https://raw.githubusercontent.com/jeedom/core/stable/install/apache_default -O /etc/apache2/sites-available/000-default.conf
...
Il faut ici ajouter les fichiers jeedom dans le répertoire du webserver (par default /var/www/jeedom) : 
...
Il vous suffit d'aller sur IP_MACHINE_JEEDOM/install/setup.php

...
https://www.jeedom.com/doc/documentation/installation/fr_FR/doc-installation.html#_création_du_cron[Vous pouvez passe à l'étape 7.2.3.]
...
Configuration de l'environement PHP pour Nginx (attention ceci est pour PHP5 pour PHP7 les commandes sont à adapter) : 
